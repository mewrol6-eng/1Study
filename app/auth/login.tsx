...
export default function LoginScreen() {
    ...
    return (
        <ScreenWrapper className="bg-white dark:bg-slate-950">
            ...
            <Animated.View entering={FadeInUp.duration(600).delay(400)} className="p-6 pb-12 w-full bg-white/50 dark:bg-slate-950/50 backdrop-blur-lg border-t border-slate-100 dark:border-slate-800">
                <Button
                    label="Продолжить"
                    size="lg"
